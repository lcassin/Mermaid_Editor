...
**Download [MermaidEditorSetup-2.1.0.exe](Installer/MermaidEditorSetup-2.1.0.exe?raw=true)** - (Latest Stable) Windows installer (self-contained, no .NET runtime required)
